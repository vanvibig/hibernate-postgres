...
import com.example.hibernatepostgres.service.MusicService;
...
@EnableCaching
public class HibernatePostgresApplication implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(HibernatePostgresApplication.class, args);
    }

    private static Logger log = LoggerFactory.getLogger(HibernatePostgresApplication.class);
